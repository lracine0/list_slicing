...
def custom_pop(input_list):
    ...
    for item in input_list:
        cout += 1
        if cout == custom_len(input_list)-1:
            temp = item
            del input_list[cout]
            return temp
...
def custom_reverse(input_list):
    ...
    """
    input_list[:] = input_list[-1:-custom_len(input_list)-1:-1]
...
def custom_equality(some_list, another_list):
    ...
    #     if custom_contains(another_list, item):
    #         cout += 1

    # if cout == custom_len(some_list):
    #     return True
    # else:
    #     return False 
